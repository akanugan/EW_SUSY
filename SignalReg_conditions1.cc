...
void SignalReg::EventLoop(const char *data,const char *inputFileList) {
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++) {
   ...
   //####################
    ...
    //----------------------case 1: if jet 1 is W and jet 2 is Z/H?   
    if(
	...
	//h_WHdPhiMETAK8->Fill(abs(DeltaPhi(METPhi,(*JetsAK8)[0].Phi())),wt);
	...
	//h2_WHAK8J1Mass_J1Tau21->Fill(((*JetsAK8_softDropMass)[0]),(((*JetsAK8_NsubjettinessTau2)[0])/((*JetsAK8_NsubjettinessTau1)[0])),wt);
	h_WHAK8J1wDisDC->Fill(((*JetsAK8_wDiscriminatorDeepDecorrel)[0]),wt);
	h_WHAK8J1zhDisDC->Fill(((*JetsAK8_zhDiscriminatorDeepDecorrel)[0]),wt);
	
	//h_WHAK8J1wDis->Fill(((*JetsAK8_wDiscriminatorDeep)[0]),wt);
	//h_WHAK8J1zhDis->Fill(((*JetsAK8_zhDiscriminatorDeep)[0]),wt);
	//h_WHAK8J1zDis->Fill(((*JetsAK8_zDiscriminatorDeep)[0]),wt);
      }
      if(JetsAK8->size() >=2){
	h_WHMET->Fill(MET,wt);
	...
	//h_WHdPhiAK8J1J2->Fill(abs(DeltaPhi((*JetsAK8)[0].Phi(),(*JetsAK8)[1].Phi())),wt);
	...
	//h2_WHAK8J2Mass_J2Tau21->Fill(((*JetsAK8_softDropMass)[1]),(((*JetsAK8_NsubjettinessTau2)[1])/((*JetsAK8_NsubjettinessTau1)[1])),wt);
	h_WHAK8J2wDisDC->Fill(((*JetsAK8_wDiscriminatorDeepDecorrel)[1]),wt);
	h_WHAK8J2zhDisDC->Fill(((*JetsAK8_zhDiscriminatorDeepDecorrel)[1]),wt);
	
	//h_WHAK8J2wDis->Fill(((*JetsAK8_wDiscriminatorDeep)[1]),wt);
	//h_AK8J2zhDis->Fill(((*JetsAK8_zhDiscriminatorDeep)[1]),wt);
	//h_WHAK8J2zDis->Fill(((*JetsAK8_zDiscriminatorDeep)[1]),wt);
	
	//h2_WHAK8J1J2Tau21->Fill(((*JetsAK8_NsubjettinessTau2)[0])/((*JetsAK8_NsubjettinessTau1)[0]),((*JetsAK8_NsubjettinessTau2)[1])/((*JetsAK8_NsubjettinessTau1)[1]),wt);
      }
    }
    
    // case 1: WX double B tag side band --> No doubleBtag for jet2
    
    if(
       ((*JetsAK8_softDropMass)[0] > 65 && (*JetsAK8_softDropMass)[0] < 90) &&
       ((*JetsAK8_wDiscriminatorDeep)[0] > 0.9) &&
       ((*JetsAK8_softDropMass)[1] > 50) &&
       ((*JetsAK8_softDropMass)[1] < 250) ){
    ...
    //----------------------case 2: if jet 1 is Z/H? and jet 2 is W   
    if(
       ((*JetsAK8_softDropMass)[1] > 65) &&
       ((*JetsAK8_softDropMass)[1] < 90) &&
       ((*JetsAK8_wDiscriminatorDeep)[1] > 0.9) &&
       ((*JetsAK8_softDropMass)[0] > 50) && ((*JetsAK8_softDropMass)[0] < 250) &&
	...
	//h_HWdPhiMETAK8->Fill(abs(DeltaPhi(METPhi,(*JetsAK8)[0].Phi())),wt);
	//*GenParticles)[2] is verified to be a W with pdgID=24
	// printf("HERE\n");
	// printf("size of gen particles: %f\n",GenParticles->size());
	// h_dRGenAK8J1->Fill(abs(DeltaR((*GenParticles)[2].Eta(),(*GenParticles)[2].Phi(),(*JetsAK8)[0].Eta(),(*JetsAK8)[0].Phi())),wt);
	...
	// printf("HERE\n");
	// h2_Tau21dRAK8J1->Fill(abs(DeltaR((*GenParticles)[2].Eta(),(*GenParticles)[2].Phi(),(*JetsAK8)[0].Eta(),(*JetsAK8)[0].Phi())),((*JetsAK8_NsubjettinessTau2)[0])/((*JetsAK8_NsubjettinessTau1)[0]),wt);
	//h2_HWAK8J1Mass_J1Tau21->Fill(((*JetsAK8_softDropMass)[0]),(((*JetsAK8_NsubjettinessTau2)[0])/((*JetsAK8_NsubjettinessTau1)[0])),wt);
	h_HWAK8J1wDisDC->Fill(((*JetsAK8_wDiscriminatorDeepDecorrel)[0]),wt);
	h_HWAK8J1zhDisDC->Fill(((*JetsAK8_zhDiscriminatorDeepDecorrel)[0]),wt);
	
	//h_HWAK8J1wDis->Fill(((*JetsAK8_wDiscriminatorDeep)[0]),wt);
	//h_HWAK8J1zhDis->Fill(((*JetsAK8_zhDiscriminatorDeep)[0]),wt);
	//h_HWAK8J1zDis->Fill(((*JetsAK8_zDiscriminatorDeep)[0]),wt);
      }
      if(JetsAK8->size() >=2){
	h_HWMET->Fill(MET,wt);
	...
	//h_HWdPhiAK8J1J2->Fill(abs(DeltaPhi((*JetsAK8)[0].Phi(),(*JetsAK8)[1].Phi())),wt);
	// h_dRGenAK8J2->Fill(abs(DeltaR((*GenParticles)[2].Eta(),(*GenParticles)[2].Phi(),(*JetsAK8)[1].Eta(),(*JetsAK8)[1].Phi())),wt);
	// h2_DisdRAK8J2->Fill(abs(DeltaR((*GenParticles)[2].Eta(),(*GenParticles)[2].Phi(),(*JetsAK8)[1].Eta(),(*JetsAK8)[1].Phi())),((*JetsAK8_wDiscriminatorDeepDecorrel)[1]),wt);
	// h2_Tau21dRAK8J2->Fill(abs(DeltaR((*GenParticles)[2].Eta(),(*GenParticles)[2].Phi(),(*JetsAK8)[1].Eta(),(*JetsAK8)[1].Phi())),((*JetsAK8_NsubjettinessTau2)[1])/((*JetsAK8_NsubjettinessTau1)[1]),wt);
	// h2_dRAK8J1J2->Fill(abs(DeltaR((*GenParticles)[2].Eta(),(*GenParticles)[2].Phi(),(*JetsAK8)[1].Eta(),(*JetsAK8)[1].Phi())),abs(DeltaR((*GenParticles)[2].Eta(),(*GenParticles)[2].Phi(),(*JetsAK8)[0].Eta(),(*JetsAK8)[0].Phi())),wt);
	//h2_HWAK8J2Mass_J2Tau21->Fill(((*JetsAK8_softDropMass)[1]),(((*JetsAK8_NsubjettinessTau2)[1])/((*JetsAK8_NsubjettinessTau1)[1])),wt);
	h_HWAK8J2wDisDC->Fill(((*JetsAK8_wDiscriminatorDeepDecorrel)[1]),wt);
	h_HWAK8J2zhDisDC->Fill(((*JetsAK8_zhDiscriminatorDeepDecorrel)[1]),wt);
	
	//h_HWAK8J2wDis->Fill(((*JetsAK8_wDiscriminatorDeep)[1]),wt);
	//h_AK8J2zhDis->Fill(((*JetsAK8_zhDiscriminatorDeep)[1]),wt);
	//h_HWAK8J2zDis->Fill(((*JetsAK8_zDiscriminatorDeep)[1]),wt);
	
	//h2_HWAK8J1J2Tau21->Fill(((*JetsAK8_NsubjettinessTau2)[0])/((*JetsAK8_NsubjettinessTau1)[0]),((*JetsAK8_NsubjettinessTau2)[1])/((*JetsAK8_NsubjettinessTau1)[1]),wt);
      }
    } // close 2Btag
    
    //--------case2 with no double b tag
    if(
       ((*JetsAK8_softDropMass)[1] > 65) &&
       ((*JetsAK8_softDropMass)[1] < 90) &&
       ((*JetsAK8_wDiscriminatorDeep)[1] > 0.9) &&
