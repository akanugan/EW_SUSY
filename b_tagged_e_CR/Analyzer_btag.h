...
class SignalReg : public NtupleVariables{
 ...
 public:
  ...
  TH1D *h_dR_e_AK8nearb, *h_dR_e_AK8farb;
  TH1D *h_dR_e_AK8;
  TH2D *h2_dReAk8_WdisMatched;
  TH2D *h2_dReAk8nearb_WdisMatched, *h2_dReAk8farb_WdisMatched;
  TH2D *h2_dReAk8nearb_deep2bdis, *h2_dReAk8farb_deep2bdis;
  ...
  //WorZmatch
  TH1D *h_wAK8J1Tau21, *h_wAK8J1wDisDC,*h_wAK8J1wDis, *h_wAK8J1zDis;
  TH1D *h_zAK8J1Tau21, *h_zAK8J1wDisDC,*h_zAK8J1wDis, *h_zAK8J1zDis;
...
void SignalReg::BookHistogram(const char *outFileName) {
  ...
  h_2btaggedAK8Mass = new TH1D("2btaggedAK8Mass","2b AK8 Mass",60,0,300);
  ...
  h_dR_e_AK8nearb  = new TH1D("dR_e_AK8nearb","deltaR(e,AK8near)",30,0,3);
  h_dR_e_AK8farb = new TH1D("dR_e_AK8farb","deltaR(e,AK8far)",30,0,3);

  h_dR_e_AK8 = new TH1D("dR_e_AK8","deltaR(e,AK8)",30,0,3);
  h2_dReAk8_WdisMatched = new TH2D("dReAk8_WdisMatched","x:dR(e, AK8) vs y:WdiscGenMatched",400,0,4,100,0,1);
 
  h2_dReAk8nearb_WdisMatched = new TH2D("dReAk8nearb_WdisMatched","x:dR(e, AK8nearb) vs y:WdiscGenMatched",400,0,4,100,0,1);
  h2_dReAk8farb_WdisMatched = new TH2D("dReAk8farb_WdisMatched","x:dR(e, AK8farb) vs y:WdiscGenMatched",400,0,4,100,0,1);
  h2_dReAk8nearb_deep2bdis = new TH2D("dReAk8nearb_deep2bdis","x:dR(e, AK8nearb) vs y:deep2bdis",400,0,4,100,0,1);
  h2_dReAk8farb_deep2bdis = new TH2D("dReAk8farb_deep2bdis","x:dR(e, AK8farb) vs y:deep2bdis",400,0,4,100,0,1);
  ...
  //WZW
  h_WZW1MET = new TH1D("WZW1MET","MET",200,0,2000);
  h_WZW1MT = new TH1D("WZW1mT","mT(MET,AK8J)",200,0,2000);
  h_WZW1MT2J = new TH1D("WZW1mT2J","mT(MET,AK8J2)",200,0,2000);  
  h_WZW2MET = new TH1D("WZW2MET","MET",200,0,2000);
  h_WZW2MT = new TH1D("WZW2mT","mT(MET,AK8J)",200,0,2000);
  h_WZW2MT2J = new TH1D("WZW2mT2J","mT(MET,AK8J2)",200,0,2000);  
  h_WZW3MET = new TH1D("WZW3MET","MET",200,0,2000);
  h_WZW3MT = new TH1D("WZW3mT","mT(MET,AK8J)",200,0,2000);
  h_WZW3MT2J = new TH1D("WZW3mT2J","mT(MET,AK8J2)",200,0,2000);  
  h_WZW4MET = new TH1D("WZW4MET","MET",200,0,2000);
  h_WZW4MT = new TH1D("WZW4mT","mT(MET,AK8J)",200,0,2000);
  h_WZW4MT2J = new TH1D("WZW4mT2J","mT(MET,AK8J2)",200,0,2000);  
...
// Mass SB
  ...
  //WorZ match
  h_wAK8J1Tau21 = new TH1D("wAK8J1Tau21","AK8 J1 Tau21",100,0,1);
  h_wAK8J1zDis = new TH1D("wAK8J1zDis","AK8 J1 zDisc.",100,0,1);
  h_wAK8J1wDis = new TH1D("wAK8J1wDis","AK8 J1 w Discr.Deep",100,0,1); 
  h_wAK8J1wDisDC = new TH1D("wAK8J1wDisDC","AK8 J1 w Discr.DeepDecorelated",100,0,1); 

  h_zAK8J1Tau21 = new TH1D("zAK8J1Tau21","AK8 J1 Tau21",100,0,1);
  h_zAK8J1zDis = new TH1D("zAK8J1zDis","AK8 J1 zDisc.",100,0,1);
  h_zAK8J1wDis = new TH1D("zAK8J1wDis","AK8 J1 w Discr.Deep",100,0,1); 
  h_zAK8J1wDisDC = new TH1D("zAK8J1wDisDC","AK8 J1 w Discr.DeepDecorelated",100,0,1); 
