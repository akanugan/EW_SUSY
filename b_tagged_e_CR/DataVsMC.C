...
void DataVsMC(){
  ...
  gStyle->SetOptStat(0);
  gStyle->SetTitle(0);
  TString varName = "wzMETvBin_RegC";
  TString varName2 = "HWMET";
  bool secondSig = false;
  TString xLabel = "MET in Reg C1 (GeV)";
  int rebin=1;

  //MC 2018 only
  // f[0] = new TFile("ST__MC2016.root");
  // f[1] = new TFile("QCD_HT_MC2016.root");
  // f[2] = new TFile("TTJets_MC2016.root");
  // f[3] = new TFile("WJetsToLNu_HT_MC2016.root");
  // f[4] = new TFile("ZJetsToNuNu_HT_MC2016.root");
  // f[5] = new TFile("Rare_MC2016.root");


  //Data
  //  f[6] = new TFile("MET_Run2016.root");
  //f[7] = new TFile("MET_Run2016.root");
  //  f[6] = new TFile("MET_Run2016.root");
  ...
  hRatio->Divide(stack_sum);   //  data/MC
...
void drawlegend(TH1D *hist,int i,const char* fname){
  ...
  else if(lName.Contains("Run2016")){lName="Data2016";}
  else if(lName.Contains("Run2017")){lName="Data2017";}
  else if(lName.Contains("Run2018")){lName="Data2018";}
  else if(lName.Contains("Run2.root")){lName="Data";}
