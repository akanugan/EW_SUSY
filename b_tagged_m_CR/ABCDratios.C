...
void ABCDratios(){
  ...
  TFile * file_output;
  TString filename = "W+Jets";     //file name to be saved
  TString name;
  ...
  TH1F * h_Bkg1 = (TH1F*) file_inputdistributions->Get("wzAK82btaggedMassSB_RegA");
  TH1F * h_Bkg2 = (TH1F*) file_inputdistributions->Get("wzAK82btaggedMassSB_RegC");  //WHAK8J1MassNo2bTag      //WHAK8J1Massnobtag
