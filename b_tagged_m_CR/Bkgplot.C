...
TFile *f[nfiles];
int col[14]={kOrange,kBlue,kPink+1,kTeal+9,kGreen,kYellow,kCyan,kRed,kBlue+2,kMagenta,kPink+1,kOrange+1,kGreen+3,kBlue+7};  //Specify Colors b's
...
void Bkgplot(){
  ...
  TString varName = "1l_MT";
  TString xLabel = "MET in Reg A (GeV)";
  int rebin=1;
  ...
  f[0] = new TFile("TTJets_MC2018.root");
