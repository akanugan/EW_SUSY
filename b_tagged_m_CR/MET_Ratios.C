...
void MET_Ratios(){
  ...
  TFile * file_output;
  TString filename = "Ratios_W+JetsBkg";     //file name to be saved
  TString name;
  

  file_inputdistributions = new TFile("WJetsToLNu_HT_MC2018.root", "READ");
  ...
  TH1F * h_Bkg1 = (TH1F*) file_inputdistributions->Get("wzMETvBin"); //wzMETvBin
  TH1F * h_Bkg2 = (TH1F*) file_inputdistributions->Get("wzMETvBin_RegC");  // wzMETvBin_RegC WHAK8J1MassNo2bTag      //WHAK8J1Massnobtag
  TH1F * h_Bkg3 = (TH1F*) file_inputdistributions->Get("wzMETvBin_RegB");  //WHAK8J1MassNo2bTag      //WHAK8J1Massnobtag
  TH1F * h_Bkg4 = (TH1F*) file_inputdistributions->Get("wzMETvBin_RegD");  //WHAK8J1MassNo2bTag      //WHAK8J1Massnobtag
  ...
  legend1->AddEntry(h_varbin,"A1/C1","l");
  legend1->AddEntry(h_Bkg3,"B/D","l");
  legend1->Draw();

  c1->Print(filename+"1.png");
  c1->Update();
