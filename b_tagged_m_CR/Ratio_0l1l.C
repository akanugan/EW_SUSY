...
void Ratio_0l1l(){
  ...
  TFile * file_output;
  TString filename = "TF_tt+Wbkg";     //file name to be saved
  TString name;
  

  file_inputdistributions = new TFile("add_0l.root", "READ");
  file_inputdistributions2 = new TFile("add_1l.root", "READ");
  ...
  TH1F * h_Bkg2 = (TH1F*) file_inputdistributions2->Get("whMETvBin");  // wzMETvBin_RegC WHAK8J1MassNo2bTag      //WHAK8J1Massnobtag
  TH1F * h_Bkg3 = (TH1F*) file_inputdistributions->Get("whMETvBin_RegC");  //WHAK8J1MassNo2bTag      //WHAK8J1Massnobtag
  TH1F * h_Bkg4 = (TH1F*) file_inputdistributions2->Get("whMETvBin_RegC");  //WHAK8J1MassNo2bTag      //WHAK8J1Massnobtag
  ...
  h_varbin->GetYaxis()->SetTitle("TF  {0l/1l}");
  h_varbin->SetStats(0);
  ...
  legend1->AddEntry(h_varbin,"0l / 1l in Reg A2","l");
  legend1->AddEntry(h_Bkg3,"0l / 1l in Reg C2","l");
  legend1->Draw();

  c1->Print(filename+"2.png");
  c1->Update();
